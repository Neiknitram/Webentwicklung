                    ...
                    <table class="table border table-borderless mt-2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="form-check-input" type="checkbox" value="" id="item2check">
                                    <label class="form-check-label" for="item2check"></label>
                                </td>
                                <!-- Buttons -->
                                <td class="text-end">
                                    <a href="#"><i class="fa-regular fa-pen-to-square"></i></a>
                ...
                <div class="row">
                    <form>
                        ...
                        <div class="form-group mb-3 mt-3">
                            ...
                            <input type="email" class="form-control mt-1" id="inputEmail" placeholder="Email-Adresse eingeben">
                        </div>
                        <!-- Password input -->
                        <div class="form-group mb-3 mt-3">
                            <label for="inputPassword">Passwort:</label>
                            <input type="password" class="form-control mt-1" id="inputPassword" placeholder="Passwort eingeben">
                        </div>
                        <!-- Assigned to project -->
