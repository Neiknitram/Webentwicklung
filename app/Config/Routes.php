...
$routes->post('/membersEdit', 'Members::editMember');
$routes->post('/membersAdd', 'Members::addMember');
$routes->post('/membersDelete', 'Members::deleteMember');
$routes->get('/projects', 'Projects::index');
$routes->post('/select_projects', 'Projects::select');
$routes->post('/add_projects', 'Projects::add');
$routes->post('/projectsEdit', 'Projects::editProject');
$routes->post('/projectsDelete', 'Projects::deleteProject');
$routes->post('/tasksAdd', 'Tasks::addTask');
$routes->post('/tasksDelete', 'Tasks::deleteTask');
$routes->post('/tasksEdit', 'Tasks::editTask');
$routes->post('/logout', 'Login::logout');
$routes->post('/tabEdit', 'Tab::editTab');
$routes->post('/tabAdd', 'Tab::addTab');
$routes->post('/tabDelete', 'Tab::deleteTab');
