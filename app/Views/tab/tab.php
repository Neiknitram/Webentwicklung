        ...
        <div class="col-12 col-lg-8 ps-4 pe-4">
            ...
            <div class="row">
                <form action="<?php echo site_url('/tabAdd'); ?>" method="post">
                    ...
                    <div class="form-group mb-3 mt-3">
                        <label for="inputText">Bezeichnung des Reiters:</label>
                        <input class="form-control" id="inputText" name="Name"
                               placeholder="Bezeichnung des Reiters eingeben">
                    </div>
                    ...
                    <button type="submit" class="btn btn-info text-light mb-2 mt-2"><i
