...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <!-- Login-Form -->
        <div class="col-12 col-lg-6 mx-auto ps-4 pe-4">
            <div class="row">
                ...
                <form method="post" action="<?php echo base_url('/login'); ?>">
                    ...
                    <div class="form-group mb-2 mt-4">
                        ...
                        <input type="email"
                               class="form-control mt-1 <?= (isset($error['inputEmail'])) ? 'is-invalid' : '' ?>"
                               name="inputEmail"
                               placeholder="Email-Adresse eingeben"
                               value="<?= (isset($login['inputEmail'])) ? $login['inputEmail'] : '' ?>">
                    ...
                    <div class="form-group mb-2 mt-2">
                        ...
                        <input type="password"
                               class="form-control mt-1 <?= (isset($error['inputPassword'])) ? 'is-invalid' : '' ?>"
                               name="inputPassword"
                               placeholder="Passwort eingeben"
                               value="<?= (isset($login['inputPassword'])) ? $login['inputPassword'] : '' ?>">
                        <div class="invalid-feedback">
                    ...
                    <!-- Login button -->
                    <button type="submit" class="btn btn-primary mb-2 mt-2" value="Login">Einloggen <i
